...
export const NON_WSK_ACTIONS: Omit<NonWSKAction, 'type'>[] = [
  { codeId: 514, keyCode: 'AltLeft', variant: ActionVariant.Left },
  { codeId: 518, keyCode: 'AltRight', variant: ActionVariant.Right },
  { codeId: 298, keyCode: 'Backspace' },
  { codeId: 313, keyCode: 'CapsLock' },
  { codeId: 357, keyCode: 'ContextMenu' },
  { codeId: 480, keyCode: 'ControlLeft', variant: ActionVariant.Left },
  { codeId: 512, keyCode: 'ControlLeft', variant: ActionVariant.Left },
  { codeId: 516, keyCode: 'ControlRight', variant: ActionVariant.Right },
  { codeId: 296, keyCode: 'Enter' },
  { codeId: 515, keyCode: 'MetaLeft', variant: ActionVariant.Left },
  { codeId: 519, keyCode: 'MetaRight', variant: ActionVariant.Right },
  { codeId: 513, keyCode: 'ShiftLeft', variant: ActionVariant.Left },
  { codeId: 517, keyCode: 'ShiftRight', variant: ActionVariant.Right },
  { codeId: 32, keyCode: 'SpaceLeft', variant: ActionVariant.Left },
  { codeId: 300, keyCode: 'SpaceLeft', variant: ActionVariant.Left },
  { codeId: 544, keyCode: 'SpaceRight', variant: ActionVariant.Right },
...
export const NON_KEY_ACTIONS: Omit<NonKeyAction, 'type'>[] = [
  ...
  { codeId: 524, actionName: 'ReleaseNext' },
  { codeId: 532, actionName: 'GTM' },
  { codeId: 534, actionName: 'Impulse' },
  { codeId: 536, actionName: 'Dup' },
  {
    codeId: 540,
    actionName: 'AmbidextrousThrowoverLeft',
    variant: ActionVariant.Left,
  },
  {
    codeId: 542,
    actionName: 'AmbidextrousThrowoverRight',
    variant: ActionVariant.Right,
  },
  { codeId: 548, actionName: 'PrimaryKeymapLeft', variant: ActionVariant.Left },
  {
    codeId: 549,
    actionName: 'PrimaryKeymapRight',
    variant: ActionVariant.Right,
  },
  {
    codeId: 550,
    actionName: 'SecondaryKeymapLeft',
    variant: ActionVariant.Left,
  },
  {
    codeId: 551,
    actionName: 'SecondaryKeymapRight',
    variant: ActionVariant.Right,
  },
  {
    codeId: 552,
    actionName: 'TertiaryKeymapLeft',
    variant: ActionVariant.Left,
  },
  {
    codeId: 553,
    actionName: 'TertiaryKeymapRight',
    variant: ActionVariant.Right,
  },
  {
    codeId: 554,
    actionName: 'QuaternaryKeymapLeft',
    variant: ActionVariant.Left,
  },
  {
    codeId: 555,
    actionName: 'QuaternaryKeymapRight',
    variant: ActionVariant.Right,
  },
  {
    codeId: 558,
