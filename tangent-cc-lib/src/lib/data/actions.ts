...
export const NON_WSK_ACTIONS: Omit<NonWSKAction, 'type'>[] = [
  ...
  { codeId: 32, keyCode: 'Space', variant: ActionVariant.Left },
  { codeId: 300, keyCode: 'Space', variant: ActionVariant.Left },
  { codeId: 544, keyCode: 'Space', variant: ActionVariant.Right },
